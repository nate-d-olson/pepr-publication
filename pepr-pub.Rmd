...
```{r echo = FALSE, message=FALSE, warning=FALSE, fig.scap= "PEPR workflow.", fig.cap = "White objects are pipeline inputs, grey objects are the three pipeline components, light blue objects are the pipeline products."}
