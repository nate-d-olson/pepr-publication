...
### Genome assembly
* Optical mapping and short read data support the assembly
* assembly represents the consensus genome for the population
* the pipeline does not attempt to identify or characterize low frequency structural variants within the population of cells which the DNA was extracted from

### Base level analysis
* X% of positions > 99% purity for both platforms, and all positions > X% purity for at least one of the two short read technologies.
* Initial analysis of bias metric values in relation to purity values for the two short read platforms unable to identify position with levels of biological variablility as the individual base level
* Use of additional metrics and algorithms developed for the identification of low frequency variants, such as lowfreq.  Can help identify positions with low levels of biological variability.
* High purity values and material homogeneity

### Genomic Purity
* Low levels of contaminants for the materials
* Identified contaminants most likely from reagents and not material itself
    * difference is contaminant abundance and profile between the short read platforms supports this conclusion
* Contaminants - previously identified as common reagent contaminants

## Conclusions
* Pipeline provides an initial framework for chracterizing microbial genomic reference materials.
* As the field matures and understanding of the measurement process, new algorithms can be incorporated into the pipeline increasing the quality of material characterization results.
