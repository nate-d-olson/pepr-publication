...
Independent libraries were constructed from 8 replicate Staphylococcus aureus microbial genomic DNA reference material (RM8376) vials the libraries were pooled and sequenced in a single run. Libraries were prepared using the Applied Biosystems automated Library Builder system using the Ion Xpress Plus kit (lot #1650102), including the Ion Xpress plus fragment plus library kit, with a 318C chip. The 8 vials were barcoded using the IonXpress Kit (vials numbers correlate with MiSeq data vial numbers). The template was prepared using the Ion PGM Template OT2 400 kit and the IonPGM400 kit was used for sequencing. Base calls were made using the Torrent Suite version 4.4.2
