...
%%% Steve's comments
%%% I read through your manuscript and have attached my suggested typo corrections.  One larger scale comment: the paper felt a little too repetitive while reading – the methods, results, and discussion all repeated the genome evaluation, genome characterization and genomic purity trifecta.  If possible, it could be helpful to either combine some of these descriptions or to more strongly differentiate their respective messages.
...
%%% What are the summary statistics? from samtools and Picard?
